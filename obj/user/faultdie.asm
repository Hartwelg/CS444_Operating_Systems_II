...
sys_env_destroy(envid_t envid)
{
  ...
  800b70:	00 
  800b71:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800b78:	00 
  800b79:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b80:	00 
  800b81:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
  800b88:	e8 eb 02 00 00       	call   800e78 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c02:	00 
  800c03:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800c0a:	00 
  800c0b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c12:	00 
  800c13:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
  800c1a:	e8 59 02 00 00       	call   800e78 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c55:	00 
  800c56:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800c5d:	00 
  800c5e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c65:	00 
  800c66:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
  800c6d:	e8 06 02 00 00       	call   800e78 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ca8:	00 
  800ca9:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800cb0:	00 
  800cb1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb8:	00 
  800cb9:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
  800cc0:	e8 b3 01 00 00       	call   800e78 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cfb:	00 
  800cfc:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800d03:	00 
  800d04:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d0b:	00 
  800d0c:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
  800d13:	e8 60 01 00 00       	call   800e78 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d4e:	00 
  800d4f:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800d56:	00 
  800d57:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d5e:	00 
  800d5f:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
  800d66:	e8 0d 01 00 00       	call   800e78 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800dc3:	00 
  800dc4:	c7 44 24 08 c4 13 80 	movl   $0x8013c4,0x8(%esp)
  800dcb:	00 
  800dcc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dd3:	00 
  800dd4:	c7 04 24 e1 13 80 00 	movl   $0x8013e1,(%esp)
  800ddb:	e8 98 00 00 00       	call   800e78 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800df5:	75 50                	jne    800e47 <set_pgfault_handler+0x5f>
		// First time through!
		// LAB 4: Your code here.
		if ((r = sys_page_alloc (0, (void *)(UXSTACKTOP-PGSIZE), PTE_W | PTE_U | PTE_P) < 0))
  800df7:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800dfe:	00 
  800dff:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800e06:	ee 
  800e07:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800e0e:	e8 c0 fd ff ff       	call   800bd3 <sys_page_alloc>
  800e13:	85 c0                	test   %eax,%eax
  800e15:	79 1c                	jns    800e33 <set_pgfault_handler+0x4b>
		{
			panic("set_pgfault_handler: bad sys_page_alloc");
  800e17:	c7 44 24 08 f0 13 80 	movl   $0x8013f0,0x8(%esp)
  800e1e:	00 
  800e1f:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800e26:	00 
  800e27:	c7 04 24 18 14 80 00 	movl   $0x801418,(%esp)
  800e2e:	e8 45 00 00 00       	call   800e78 <_panic>
		}
		sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  800e33:	c7 44 24 04 51 0e 80 	movl   $0x800e51,0x4(%esp)
  800e3a:	00 
...
_pgfault_upcall:
  ...
  800e52:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800e59:	83 c4 04             	add    $0x4,%esp
	...
	// LAB 4: Your code here.
	movl 0x28(%esp), %edi
  800e5c:	8b 7c 24 28          	mov    0x28(%esp),%edi
	movl %esp, %ebx
  800e60:	89 e3                	mov    %esp,%ebx
	movl 0x30(%esp), %esp
  800e62:	8b 64 24 30          	mov    0x30(%esp),%esp
	pushl %edi
  800e66:	57                   	push   %edi
	movl %ebx, %esp
  800e67:	89 dc                	mov    %ebx,%esp
  ...
  800e6d:	83 c4 04             	add    $0x4,%esp
	sub $4, 0x4(%esp)
  800e70:	83 6c 24 04 04       	subl   $0x4,0x4(%esp)
	popfl
  800e75:	9d                   	popf   
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e89:	e8 07 fd ff ff       	call   800b95 <sys_getenvid>
  800e8e:	8b 55 0c             	mov    0xc(%ebp),%edx
  800e91:	89 54 24 10          	mov    %edx,0x10(%esp)
  800e95:	8b 55 08             	mov    0x8(%ebp),%edx
  800e98:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800e9c:	89 74 24 08          	mov    %esi,0x8(%esp)
  800ea0:	89 44 24 04          	mov    %eax,0x4(%esp)
  800ea4:	c7 04 24 28 14 80 00 	movl   $0x801428,(%esp)
  ...
  800eba:	e8 71 f2 ff ff       	call   800130 <vcprintf>
	cprintf("\n");
  800ebf:	c7 04 24 7a 11 80 00 	movl   $0x80117a,(%esp)
  800ec6:	e8 c6 f2 ff ff       	call   800191 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800ecb:	cc                   	int3   
  800ecc:	eb fd                	jmp    800ecb <_panic+0x53>
