...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800e29:	85 c0                	test   %eax,%eax
	void* vAddr = (void *) ULIM;
  800e2b:	ba 00 00 80 ef       	mov    $0xef800000,%edx
  ...
  800e3d:	74 16                	je     800e55 <ipc_recv+0x3d>
	{
		if (from_env_store != NULL)
  800e3f:	85 f6                	test   %esi,%esi
  800e41:	74 06                	je     800e49 <ipc_recv+0x31>
		{
			*from_env_store = 0;
  800e43:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		}
		if (perm_store != NULL) 
  800e49:	85 db                	test   %ebx,%ebx
  800e4b:	74 2c                	je     800e79 <ipc_recv+0x61>
		{
			*perm_store = 0;
  800e4d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  800e53:	eb 24                	jmp    800e79 <ipc_recv+0x61>
		}
		return x;
	}
  ...
  800e57:	74 0a                	je     800e63 <ipc_recv+0x4b>
	{
		*from_env_store = thisenv->env_ipc_from;
  800e59:	a1 04 20 80 00       	mov    0x802004,%eax
  800e5e:	8b 40 74             	mov    0x74(%eax),%eax
  800e61:	89 06                	mov    %eax,(%esi)
	}
	if (perm_store != NULL)
  800e63:	85 db                	test   %ebx,%ebx
  800e65:	74 0a                	je     800e71 <ipc_recv+0x59>
	{
		*perm_store = thisenv->env_ipc_perm;
  800e67:	a1 04 20 80 00       	mov    0x802004,%eax
  800e6c:	8b 40 78             	mov    0x78(%eax),%eax
  800e6f:	89 03                	mov    %eax,(%ebx)
	}
	// panic("ipc_recv not implemented");
	return thisenv->env_ipc_value;
  800e71:	a1 04 20 80 00       	mov    0x802004,%eax
  800e76:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800e9c:	eb 26                	jmp    800ec4 <ipc_send+0x44>
	}
	...
	{
		if (x != -E_IPC_NOT_RECV)
  800e9e:	83 f8 f9             	cmp    $0xfffffff9,%eax
  800ea1:	74 1c                	je     800ebf <ipc_send+0x3f>
		{
			panic("ipc_send");
  800ea3:	c7 44 24 08 cf 14 80 	movl   $0x8014cf,0x8(%esp)
  800eaa:	00 
  800eab:	c7 44 24 04 50 00 00 	movl   $0x50,0x4(%esp)
  800eb2:	00 
  800eb3:	c7 04 24 d8 14 80 00 	movl   $0x8014d8,(%esp)
  800eba:	e8 60 00 00 00       	call   800f1f <_panic>
		}
		sys_yield();
  800ebf:	e8 20 fd ff ff       	call   800be4 <sys_yield>
	while ((x = sys_ipc_try_send(to_env, val, pg, perm)) != 0)
  ...
  800ed6:	e8 c8 fe ff ff       	call   800da3 <sys_ipc_try_send>
  800edb:	85 c0                	test   %eax,%eax
  800edd:	75 bf                	jne    800e9e <ipc_send+0x1e>
	}
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f4b:	c7 04 24 e4 14 80 00 	movl   $0x8014e4,(%esp)
