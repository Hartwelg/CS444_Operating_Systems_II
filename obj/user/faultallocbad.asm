...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017e:	e8 51 00 00 00       	call   8001d4 <vcprintf>
	cprintf("\n");
  800183:	c7 04 24 c8 11 80 00 	movl   $0x8011c8,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002bf:	e8 5c 0c 00 00       	call   800f20 <__udivdi3>
  ...
  80031f:	e8 2c 0d 00 00       	call   801050 <__umoddi3>
  800324:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800328:	0f be 80 5b 12 80 00 	movsbl 0x80125b(%eax),%eax
...
008003be <vprintfmt>:
{
  ...
  8004ef:	c7 44 24 08 73 12 80 	movl   $0x801273,0x8(%esp)
  8004f6:	00 
  ...
  80050f:	c7 44 24 08 7c 12 80 	movl   $0x80127c,0x8(%esp)
  800516:	00 
  ...
  800541:	b8 6c 12 80 00       	mov    $0x80126c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c10:	00 
  800c11:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800c18:	00 
  800c19:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c20:	00 
  800c21:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ca2:	00 
  800ca3:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800caa:	00 
  800cab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb2:	00 
  800cb3:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cf5:	00 
  800cf6:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800cfd:	00 
  800cfe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d05:	00 
  800d06:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d48:	00 
  800d49:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800d50:	00 
  800d51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d58:	00 
  800d59:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d9b:	00 
  800d9c:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800da3:	00 
  800da4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dab:	00 
  800dac:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dee:	00 
  800def:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800df6:	00 
  800df7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dfe:	00 
  800dff:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e63:	00 
  800e64:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800e6b:	00 
  800e6c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e73:	00 
  800e74:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e95:	75 50                	jne    800ee7 <set_pgfault_handler+0x5f>
		// First time through!
		// LAB 4: Your code here.
		if ((r = sys_page_alloc (0, (void *)(UXSTACKTOP-PGSIZE), PTE_W | PTE_U | PTE_P) < 0))
  800e97:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800e9e:	00 
  800e9f:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800ea6:	ee 
  800ea7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800eae:	e8 c0 fd ff ff       	call   800c73 <sys_page_alloc>
  800eb3:	85 c0                	test   %eax,%eax
  800eb5:	79 1c                	jns    800ed3 <set_pgfault_handler+0x4b>
		{
			panic("set_pgfault_handler: bad sys_page_alloc");
  800eb7:	c7 44 24 08 d0 14 80 	movl   $0x8014d0,0x8(%esp)
  800ebe:	00 
  800ebf:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800ec6:	00 
  800ec7:	c7 04 24 f8 14 80 00 	movl   $0x8014f8,(%esp)
  800ece:	e8 69 f2 ff ff       	call   80013c <_panic>
		}
		sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  800ed3:	c7 44 24 04 f1 0e 80 	movl   $0x800ef1,0x4(%esp)
  800eda:	00 
  800edb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
...
_pgfault_upcall:
  ...
  800ef2:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800ef9:	83 c4 04             	add    $0x4,%esp
	...
	// LAB 4: Your code here.
	movl 0x28(%esp), %edi
  800efc:	8b 7c 24 28          	mov    0x28(%esp),%edi
	movl %esp, %ebx
  800f00:	89 e3                	mov    %esp,%ebx
	movl 0x30(%esp), %esp
  800f02:	8b 64 24 30          	mov    0x30(%esp),%esp
	pushl %edi
  800f06:	57                   	push   %edi
	movl %ebx, %esp
  800f07:	89 dc                	mov    %ebx,%esp
  ...
  800f0d:	83 c4 04             	add    $0x4,%esp
	sub $4, 0x4(%esp)
  800f10:	83 6c 24 04 04       	subl   $0x4,0x4(%esp)
	popfl
  800f15:	9d                   	popf   
